...
md"""
### Chips in Series for PGDN Production from Maltose
"""
...
__Compute__
* Compute the number of chips $N$ needed to reach desired purity (99.7%) and flow rate (1.0 g/hr) targets. 
...
begin
	...
	mol_flow_values_feed_1 = [
		14Vₘ/2 	; # oxygen mmol/hr
		14Vₘ/2	; # sucrose mmol/hr (or maybe 6.1?)
	]
