...
md"""
### Chips in Parallel for PGDN Production from Maltose
"""
...
__Compute__
* Compute the number of chips $N$ needed to reach desired purity (95%) and flow rate (1 g/hr) targets. 
"""
...
begin
	...
	mol_flow_values_feed_1 = [
		Vₘ/2 	; # h2o mmol/hr
		Vₘ/2 	; # maltose mmol/hr (maybe: 0.822 or 6.1?)
	]
